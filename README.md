...
> Otvoriť túto stránku na [https://filipkopecny.github.io/filip-radar-server/](https://filipkopecny.github.io/filip-radar-server/)
...
* vyhľadať **https://github.com/filipkopecny/filip-radar-server** a importovať

## Upraviť tento projekt ![Odznak stavu zostavy](https://github.com/filipkopecny/filip-radar-server/workflows/MakeCode/badge.svg)

Ak chcete upraviť tento odkladací priestor v aplikácii MakeCode.

* otvoriť [https://makecode.microbit.org/](https://makecode.microbit.org/)
* kliknite na **Importovať** a potom na **Importovať adresu URL**
* prilepte **https://github.com/filipkopecny/filip-radar-server** a kliknite na tlačidlo importu
...
![Vykreslené zobrazenie blokov](https://github.com/filipkopecny/filip-radar-server/raw/master/.github/makecode/blocks.png)
